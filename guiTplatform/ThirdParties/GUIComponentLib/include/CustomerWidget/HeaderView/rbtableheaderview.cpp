...
//bool RbTableHeaderView::event(QEvent *e)
//{
//    switch (e->type()) {
//    case QEvent::HoverEnter: {
//        QHoverEvent *he = static_cast<QHoverEvent*>(e);
//        this->hover = logicalIndexAt(he->pos());
//        if (this->hover != -1)
//            updateSection(this->hover);
//        break; }
//    case QEvent::Leave:
...
//        QHoverEvent *he = static_cast<QHoverEvent*>(e);
//        int oldHover = this->hover;
//        this->hover = logicalIndexAt(he->pos());
//        if (this->hover != oldHover) {
//            if (oldHover != -1)
...
void RbTableHeaderView::paintSection(QPainter* painter, const QRect& rect, int logicalIdx) const
{
    ...
    for (int i = 0; i < LEVEL_CNT; ++i)
    {
        ...
        {
            if (logicalIdx == this->hover)
                state |= QStyle::State_MouseOver;
            if (logicalIdx == this->pressed)
