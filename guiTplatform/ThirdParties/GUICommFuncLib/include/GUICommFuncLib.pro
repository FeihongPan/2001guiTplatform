...
TEMPLATE = lib
DEFINES += GUICOMMFUNCLIB_LIBRARY

CONFIG += c++11

CONFIG(debug,debug|release){
    TARGET = GUICommFuncLibd
} else {
    TARGET = GUICommFuncLib
}

CONFIG += skip_target_version_ext
VERSION = 1.0.0
QMAKE_TARGET_PRODUCT = "iStar GUICommFuncLib Library"
QMAKE_TARGET_DESCRIPTION = "Gui Common Software Function Module"
...
include($$PWD/AuthorityComponent/AuthorityComponent.pri)
include($$PWD/AuthorityManage/AuthorityManage.pri)
include($$PWD/BindableComponent/BindableComponent.pri)
include($$PWD/DataLog/DataLog.pri)
